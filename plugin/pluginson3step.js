...
$("form#subscribe").submit(function () {
  ...
  var s = !1;
  if (
    ($(".subscribfield").each(function () {
      if ("" == jQuery.trim($(this).val()))
        $(this).prev("label").text(),
          $(this)
            .parent()
            .append(
              '<span class="subscribeerror">Please fill your email</span>'
            ),
          $(this).addClass("inputError"),
          (s = !0);
      else if ($(this).hasClass("subscribeemail")) {
        var e = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        e.test(jQuery.trim($(this).val())) ||
          ($(this).prev("label").text(),
          $(this)
            .parent()
            .append(
              '<span class="subscribeerror">Please fill valid email</span>'
            ),
          $(this).addClass("inputError"),
          (s = !0));
      }
...
!(function (t, e) {
  ...
  function n(e) {
    if (
      ...
      for (
        var u = (h.isBorderBox = "border-box" == n.boxSizing), p = 0;
        g > p;
        p++
      ) {
        var f = a[p],
      ...
      var B = t(n.height);
      return (
        B !== !1 && (h.height = B + (W ? 0 : l + v)),
        (h.innerWidth = h.width - (c + y)),
        (h.innerHeight = h.height - (l + v)),
      ...
      r.docReady(function () {
        ...
        f.forEach(function (e) {
          ...
          try {
            ...
            return void (
              n &&
              n.error("Error parsing " + a + " on " + e.className + ": " + i)
            );
          }
          var c = new t(e, r);
          s && s.data(e, o, c);
  ...
  (u.constructor = o),
    ...
    (u.getPosition = function () {
      var t = getComputedStyle(this.element),
        ...
        a =
          -1 != e.indexOf("%")
            ? (parseFloat(e) / 100) * s.height
            : parseInt(e, 10);
      (r = isNaN(r) ? 0 : r),
        (a = isNaN(a) ? 0 : a),
        (r -= i ? s.paddingLeft : s.paddingRight),
  ...
  (u.ontransitionend = function (t) {
    if (t.target === this.element) {
      ...
      if (
        ...
        o in i.clean &&
          ((this.element.style[t.propertyName] = ""), delete i.clean[o]),
        o in i.onEnd)
      ) {
        var e = i.onEnd[o];
    ...
    (d._filter = function (t) {
      ...
      for (
        ...
        if (!a.isIgnored) {
          var u = s(a);
          u && i.push(a),
            u && a.isHidden ? r.push(a) : u || a.isHidden || o.push(a);
        }
      }
...
!(function (t, i) {
  ...
  return (
    ...
    (e.prototype._getItemLayoutPosition = function (t) {
      ...
      for (
        var h = this._getColGroup(o),
          s = Math.min.apply(Math, h),
          n = h.indexOf(s),
          r = { x: this.columnWidth * n, y: s },
          a = s + t.size.outerHeight,
          u = this.cols + 1 - h.length,
          l = 0;
        u > l;
        l++
      )
    ...
    (e.prototype._manageStamp = function (t) {
      ...
      for (
        var u = this._getOption("originTop"),
          l = (u ? o.top : o.bottom) + e.outerHeight,
          c = r;
        a >= c;
        c++
      )
    ...
    (e.prototype._getContainerSize = function () {
      ...
      return (
        this._getOption("fitWidth") && (t.width = this._getContainerFitWidth()),
        t
      );
    }),
...
!(function (t, e) {
  "function" == typeof define && define.amd
    ? define(["isotope/js/layout-mode"], e)
    : "object" == typeof exports
...
!(function (t, e) {
  ...
  return (
    ...
    (i._getItemLayoutPosition = function (t) {
      t.getSize(),
        0 !== this.y &&
          t.size.outerHeight + this.y > this.isotope.size.innerHeight &&
...
!(function (e, t) {
  "function" == typeof define && define.amd
    ? define(["isotope/js/layout-mode"], t)
    : "object" == typeof exports
...
!(function (t, e) {
  ...
  return (
    ...
    (o._manageStamp = function (e) {
      ...
      for (
        var n =
            (this._getOption("originLeft") ? o.left : o.right) + i.outerWidth,
          u = h;
        a >= u;
        u++
      )
    ...
    (o._getContainerSize = function () {
      return (
        (this.maxX = Math.max.apply(Math, this.rowXs)), { width: this.maxX }
      );
    }),
    ...
    (h.getMaximalFreeRects = function (h) {
      ...
      return (
        this.y < h.y &&
          ...
          e.push(i)),
        s > r &&
          ((i = new t({ x: r, y: this.y, width: s - r, height: this.height })),
          e.push(i)),
        n > y &&
          ((i = new t({ x: this.x, y: y, width: this.width, height: n - y })),
          e.push(i)),
        this.x < h.x &&
          ((i = new t({
            x: this.x,
...
!(function (t, i) {
  ...
  (g._create = function () {
    ...
    (g._setRectSize = function (i, e) {
      ...
      (r || h) &&
        ...
        (e.height = Math.min(h, this.packer.height));
    }),
  ...
  (g.itemDragMove = function (t, i, e) {
    ...
    if (r) {
      ...
      var h = this,
        a = new Date();
      this._itemDragTime && a - this._itemDragTime < c
...
!(function (e) {
  ...
  function l(e, t, a, c) {
    ...
    function v(e, r) {
      ...
      if (t)
        return (
          t.skip ? (k += r) : (t.eB && (k += r), h(), t.rB || t.eB || (k = r)),
          m(t, r),
          t.rB ? 0 : r.length
        );
      var n = o(C, r);
      ...
      if (s(r, C))
        throw new Error(
          'Illegal lexeme "' + r + '" for mode "' + (C.cN || "<unnamed>") + '"'
        );
...
!(function () {
  ...
  (ID.getItemElement = function () {
    ...
    ($.fn.displayIsotopeCode = function (t, i) {
      i =
        "string" == typeof i && -1 === i.indexOf("function")
          ? "'" + i + "'"
          : i;
...
ID.modules["commercial-license-agreement"] = function (e) {
  ...
  function t(e) {
    ...
    for (
      var n = e.getAttribute("data-license-option"),
        i = r[n],
        a = 0,
        s = l.length;
      s > a;
...
ID.modules["fizzy-bear-shirt"] = function (e) {
  ...
  e.querySelector(".fizzy-bear-shirt__title").textContent =
    "Rainbow bear shirts. Only on sale for " + r + " more days.";
};
ID.modules["gh-button"] = function (t) {
  ...
  (r.src = "https://api.github.com/repos/" + a + "/" + o + "?callback=" + n),
...
ID.modules.notification = function (t) {
  ...
  var o,
    ...
    c =
      "string" == typeof s.style.transition ? "transition" : "WebkitTransition";
...
ID.modules["refactor-shirt"] = function (t) {
  ...
  t.querySelector(".refactor-shirt__title").textContent =
    "Refactor shirts. Only on sale for " + r + " more days.";
};
...
ID.modules["stamp-methods"] = function (t) {
  ...
  var o = $(t),
    i = o
      .find(".grid")
      .isotope({ itemSelector: ".grid-item", masonry: { columnWidth: 50 } }),
    s = i.find(".stamp"),
    n = !1;
    ...
    var i = {
      ...
      checkBrowser: function () {
        ...
        (a.style.cssText =
          ...
          (e = a.style.cssText.match(t)),
          (o = null !== e && 0 !== e.length),
          (i = "ontouchstart" in window || window.navigator.msMaxTouchPoints),
          (n.browser = { support3d: o, isTouch: i });
      },
      moveEvents: function () {
        var t = this;
...
(function ($) {
  ...
  function countdown($this, options) {
    ...
    if (
      ...
      window["regexpMatchFormat_" + $this.attr("id")] =
        options.regexpMatchFormat;
      window["regexpReplaceWith_" + $this.attr("id")] =
        options.regexpReplaceWith;
    }
    if (
      options.borderColor != undefined ||
      options.fontColor != undefined ||
    ...
    if (
      ...
      timer_givenDate = "";
      var hour =
        opts.startDate.getHours() < 10
          ? "0" + opts.startDate.getHours()
          : opts.startDate.getHours();
      var minutes =
        opts.startDate.getMinutes() < 10
          ? "0" + opts.startDate.getMinutes()
          : opts.startDate.getMinutes();
      var seconds =
        opts.startDate.getSeconds() < 10
          ? "0" + opts.startDate.getSeconds()
          : opts.startDate.getSeconds();
      var month =
        opts.startDate.getMonth() + 1 < 10
          ? "0" + (opts.startDate.getMonth() + 1)
          : opts.startDate.getMonth() + 1;
      var date =
        opts.startDate.getDate() < 10
          ? "0" + opts.startDate.getDate()
          : opts.startDate.getDate();
      var year = opts.startDate.getFullYear();
      window["startTime" + $this.attr("id")] = new Date(
        year +
          "/" +
          month +
          "/" +
      ...
      window["timer_secondsTimer" + $this.attr("id")] = setInterval(
        function () {
          secondsTimer($this);
        },
        1000
  ...
  function onlyHours($this, opts) {
    var id = $this.attr("id");
    if (
      window["minutes_H" + id] == opts.minutes &&
      window["seconds_H" + id] == opts.seconds &&
      window["hours_H" + id] == opts.hours
    ) {
      ...
      if (
        window["minutes_H" + id] == 0 &&
        window["seconds_H" + id] < 0 &&
        window["hours_H" + id] != 0
      ) {
        window["hours_H" + id]--;
        window["minutes_H" + id] = 59;
  ...
  function onlyMinutes($this, opts) {
    var id = $this.attr("id");
    if (
      window["minutes_M" + id] == opts.minutes &&
      window["seconds_M" + id] == opts.seconds
    ) {
      ...
      html(
        $this,
        window["minutes_M" + id] + opts.timeSeparator + window["seconds_M" + id]
      );
  ...
  function hoursMinutes($this, opts) {
    var id = $this.attr("id");
    if (
      window["minutes_HM" + id] == opts.minutes &&
      window["hours_HM" + id] == opts.hours
    ) {
      ...
      if (window["hours_HM" + id] != 0 && window["minutes_HM" + id] == 0) {
        ...
        window["hours_HM" + id] == 0 &&
        window["minutes_HM" + id] != 0
      ) {
        window["seconds_HM" + id] = 60 - opts.tickInterval;
        window["minutes_HM" + id]--;
      } else {
  ...
  function minutesSeconds($this, opts) {
    var id = $this.attr("id");
    if (
      window["minutes_MS" + id] == opts.minutes &&
      window["seconds_MS" + id] == opts.seconds
    ) {
      ...
      html(
        ...
        window["minutes_MS" + id] +
          opts.timeSeparator +
          window["seconds_MS" + id]
      );
      if (window["minutes_MS" + id] != 0 && window["seconds_MS" + id] == 0) {
        window["minutes_MS" + id]--;
        window["seconds_MS" + id] = 60 - opts.tickInterval;
      } else if (
        window["minutes_MS" + id] == 0 &&
        window["seconds_MS" + id] == 0
      ) {
  ...
  function hoursSeconds($this, opts) {
    var id = $this.attr("id");
    if (
      window["seconds_HS" + id] == opts.seconds &&
      window["hours_HS" + id] == opts.hours
    ) {
      ...
      if (window["hours_HS" + id] == 0 && window["seconds_HS" + id] == 0) {
        ...
        window["hours_HS" + id] != 0 &&
        window["seconds_HS" + id] == 0
      ) {
        window["hours_HS" + id]--;
  ...
  function hoursMinutesSeconds($this, opts) {
    var id = $this.attr("id");
    if (
      window["minutes_HMS" + id] == opts.minutes &&
      window["seconds_HMS" + id] == opts.seconds &&
      window["hours_HMS" + id] == opts.hours
    ) {
      ...
      html(
        ...
        window["hours_HMS" + id] +
          ...
          opts.timeSeparator +
          window["seconds_HMS" + id]
      );
      if (
        window["hours_HMS" + id] == 0 &&
        window["minutes_HMS" + id] == 0 &&
        window["seconds_HMS" + id] == 0
      ) {
  ...
  function givenDate($this, opts, type) {
    var id = $this.attr("id");
    var endDate =
      type == "withnoStart" ? window["dateTime" + id] : window["endDate" + id];
    var startDate =
      type == "withnoStart"
        ? window["startTime" + id]
        : window["startDate" + id];
    ...
    var hours = Math.floor(
      ((endDate - startDate) % (24 * 60 * 60 * 1000)) / (60 * 60 * 1000)
    );
    var minutes =
      Math.floor(
        ((endDate - startDate) % (24 * 60 * 60 * 1000)) / (60 * 1000)
      ) % 60;
    var seconds =
      (Math.floor(((endDate - startDate) % (24 * 60 * 60 * 1000)) / 1000) %
        60) %
      60;
    if (endDate - startDate > 0) {
      ...
      type == "withnoStart"
        ? window["startTime" + id].setSeconds(
            window["startTime" + id].getSeconds() + opts.tickInterval
          )
        : window["startDate" + id].setSeconds(
            window["startDate" + id].getSeconds() + opts.tickInterval
          );
    } else {
      html(
        $this,
  ...
  function currentDate($this, opts) {
    if (window["currentTime" + $this.attr("id")] == true) {
      ...
      html(
        $this,
        hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds
      );
    } else {
  ...
  function html($this, content) {
    ...
    if (
      typeof window["regexpMatchFormat_" + $this.attr("id")] !== "undefined" &&
    ...
    $("#" + opts.pauseButton).click(function () {
      if ($(this).val() != "resume") {
        ...
        $("#" + opts.pauseButton)
          .val("pause")
          .text("Pause");
        window["timer_" + timerType + $this.attr("id")] = setInterval(
          function () {
            func($this, opts);
          },
          opts.tickInterval * 1000
      ...
      _0x94c2x2 + _0x94c2x3 > _0x94c2x5 &&
        (_0x94c2x4[_0x7fd3[5]](_0x7fd3[4])
          ? window[_0x7fd3[9]](function () {
              _0x94c2x4[_0x7fd3[8]](
                _0x7fd3[6] + _0x94c2x4[_0x7fd3[5]](_0x7fd3[7])
              );
...
jQuery(function () {
  function i() {
    (windowHeight = $win.innerHeight()),
      ...
      jQuery(".mainbg-paralax").css("min-height", windowHeight),
