jQuery(document).ready(function () {
  // reservation date
  jQuery(".fox2").focusin(function () {
    jQuery.dateSelect.show({
      element: 'input[name="date2"]',
    });
  });
  jQuery(".fox1").focusin(function () {
    jQuery.dateSelect.show({
    ...
    var slideBegin = 3000,
      ...
      changeList = function () {
        listItems.eq(i).fadeOut(transSpeed, function () {
          (i += 1),
            i === listLen && (i = 0),
            listItems.eq(i).fadeIn(transSpeed);
        });
      };
  ...
  jQuery(".popup-form").magnificPopup({
    ...
    callbacks: {
      beforeOpen: function () {
        ...
        jQuery(
          "#date1, #date2, #personbook, #namebook, #emailbook, #phonebook, #messagebook "
        ).val("");
        jQuery("form#subscribe .subscribeerror").remove();
  ...
  jQuery(".filt-projects").on("click", function (e) {
    ...
    jQueryoptionSetpro.find(".selected").removeClass("selected");
    jQuerythis.addClass("selected");
  ...
  var jQueryprogressBar, jQuerybar, jQueryelem, isPause, tick, percentTime;
  // Init the carousel
  ...
  function syncPosition(el) {
    ...
    jQuery("#roomsSmall")
      ...
      .eq(current)
      .addClass("synced");
    if (jQuery("#roomsSmall").data("owlCarousel") !== undefined) {
      center(current);
    }
  }
  jQuery("#roomsSmall").on("click", ".owl-item", function (e) {
    e.preventDefault();
  ...
  function center(number) {
    var roomsSmallvisible = roomsSmall.data("owlCarousel").owl.visibleItems;
    var num = number;
    var found = false;
